...
svo_lib_build_path = os.path.join('/home/apoorv/rl_vio/rl_vo/vo_rl/svo-lib/build/svo_env')
...
class VecSVOEnv(VecEnv):
    ...
    def __init__(self, params_yaml_path, calib_yaml_path, dataset_dir, num_envs, mode, reward_config,
                 initialize_glog=False, val_traj_ids=None, dataset='euroc'):
        ...
        # print("initialize_glog: ", initialize_glog)
        # print("val_traj_ids: ", val_traj_ids)
